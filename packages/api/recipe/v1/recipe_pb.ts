...
/**
 * @generated from message recipev1.Recipe
 */
export class Recipe extends Message<Recipe> {
  ...
  static readonly typeName = "recipev1.Recipe";
...
/**
 * @generated from message recipev1.GetRecipeRequest
 */
export class GetRecipeRequest extends Message<GetRecipeRequest> {
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recipev1.GetRecipeRequest";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
...
/**
 * @generated from message recipev1.GetRecipeResponse
 */
export class GetRecipeResponse extends Message<GetRecipeResponse> {
  /**
   * @generated from field: recipev1.Recipe recipe = 1;
   */
  recipe?: Recipe;
  ...
  static readonly runtime = proto3;
  static readonly typeName = "recipev1.GetRecipeResponse";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
